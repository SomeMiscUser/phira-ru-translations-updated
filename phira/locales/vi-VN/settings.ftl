...
item-cache-size-loading = Đợi một chút...
item-cache-size = Kích thước bộ nhớ đệm: { $size }
...
item-prefer-reduced-motion = Ưu tiên giảm chuyển động
...
about-content =
  ...
  Phira là một trò chơi nhịp điệu dựa trên cộng đồng phi thương mại, lấy cảm hứng từ Phigros và được phát triển bằng Rust.
  ...
  Cảm ơn tất cả các nhà tài trợ của chúng tôi! (Sắp xếp theo thứ tự bảng chữ cái)
