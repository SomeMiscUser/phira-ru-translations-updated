...
about-content =
  ...
  Phira คือ Rhythm game ที่ไม่แสวงหาผลกำไรและขับเคลื่อนโดยผู้เล่น. ได้รับแรงบันดาลมาจากเกม Phigros. พัฒนาโดยใช้ภาษา Rust.

  BiliBili Account: @Phira官方
  QQ Guild: r48eajexth

  ขอขอบคุณผู้สนับสนุนของเราทุกคนด้วย! (เรียงตามตัวอักษร)
