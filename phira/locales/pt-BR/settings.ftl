...
about-content =
  ...
  Phira é um jogo de ritmo não comercial voltado para a comunidade, inspirado em Phigros, desenvolvido com Rust. 

  Conta BiliBili: @Phira官方
  Guilda QQ: r48eajexth

  Obrigado a todos os nossos patrocinadores! (Classificado lexicograficamente) 
